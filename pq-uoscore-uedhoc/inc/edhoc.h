...
struct other_party_cred {
	...
	struct byte_array pk_kem; /*authentication public key for KEM-KEM method*/
...
struct edhoc_responder_context {
	...
	struct byte_array sk_kem_r; // static private KEM key for KEM-KEM authentication
	struct byte_array pk_kem_r; // static public KEM key for KEM-KEM authentication
...
struct edhoc_initiator_context {
	...
	struct byte_array sk_kem_i; // static private KEM key for KEM-KEM authentication
	struct byte_array pk_kem_i; // static public KEM key for KEM-KEM authentication
	void *sock; /*pointer used as handler for sockets by tx/rx */
