...
/**
 * @brief                      Calculates transcript hash TH1
 *                             TH_1 = H(K_auth_R)
 * 
 * @param alg                  Hash algorithm to be used.
 * @param[in] k_auth_r         Pointer to K_auth_R.
 * @param[out] th1             The output TH1.
 * @retval                     Ok or error.
 */
enum err th1_calculate(enum hash_alg alg, struct byte_array *k_auth_r,
             struct byte_array *th1);
