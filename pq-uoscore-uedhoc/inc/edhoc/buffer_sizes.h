...
#define SK_SIZE_KEM PQCLEAN_MLKEM512_CLEAN_CRYPTO_SECRETKEYBYTES
...
// define extra field sizes for KEM-KEM method
#define CT_AUTH_R_SIZE PQCLEAN_MLKEM512_CLEAN_CRYPTO_CIPHERTEXTBYTES
#define CT_AUTH_I_SIZE CT_AUTH_R_SIZE

#define PLAINTEXT1_SIZE (ID_CRED_I_SIZE + EAD_SIZE)
#define CIPHERTEXT1_SIZE (PLAINTEXT1_SIZE + MAC_SIZE)
// #endif // PQC
...
// #ifdef PQC
// The maximum msg sizes below are for only KEM-KEM method
#define MSG_1_SIZE (1 + SUITES_I_SIZE + G_X_SIZE + AS_BSTR_SIZE(C_I_SIZE) + EAD_SIZE + CT_AUTH_R_SIZE)
#define MSG_2_SIZE (G_Y_SIZE + CIPHERTEXT2_SIZE + AS_BSTR_SIZE(C_R_SIZE) + CT_AUTH_I_SIZE)
// #endif // PQC
