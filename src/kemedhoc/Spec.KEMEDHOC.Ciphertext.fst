...
let encrypt_plaintext1 #kcs ptx1 th1 prk1e
  = // derive K1
  let k1 = expand_k #kcs info_label_k1 prk1e th1 in
  // derive IV1
  let iv1 = expand_iv #kcs info_label_iv1 prk1e th1 in
...
let encrypt_plaintext2 #kcs ptx2 th2 prk2e
  = // derive K2
  let k2 = expand_k #kcs info_label_k2 prk2e th2 in
  // derive IV2
  let iv2 = expand_iv #kcs info_label_iv2 prk2e th2 in
...
let encrypt_plaintext3 #kcs ptx3 th3 prk3e2m
  = // derive K3
  let k3 = expand_k #kcs info_label_k3 prk3e2m th3 in
  // derive IV3
  let iv3 = expand_iv #kcs info_label_iv3 prk3e2m th3 in
